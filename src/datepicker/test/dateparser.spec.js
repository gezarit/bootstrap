describe('date parser', function () {
  ...
  describe('wih custom formats', function() {
    it('should work correctly for `dd`, `MM`, `yyyy`', function() {
      ...
      expectParse('02-05-2011', 'dd-MM-yyyy', new Date(2011, 4, 2, 0));
      expectParse('02/05/2011', 'MM/dd/yyyy', new Date(2011, 1, 5, 0));
    ...
    it('should work correctly for `M`', function() {
      expectParse('17.11.13', 'dd.M.yy', new Date(2013, 10, 17, 0));
    ...
    it('should work correctly for `MMM`', function() {
      expectParse('17.Nov.13', 'dd.MMM.yy', new Date(2013, 10, 17, 0));
    ...
    it('should work correctly for `MMMM`', function() {
      ...
      expectParse('02-May-11', 'dd-MMMM-yy', new Date(2011, 4, 2, 0));
      expectParse('February/05/1980', 'MMMM/dd/yyyy', new Date(1980, 1, 5, 0));
      expectParse('1955/February/05', 'yyyy/MMMM/dd', new Date(1955, 1, 5, 0));
    });

    it('should work correctly for `d`', function() {
      expectParse('17.November.13', 'd.MMMM.yy', new Date(2013, 10, 17, 0));
      expectParse('2-May-11', 'd-MMMM-yy', new Date(2011, 4, 2, 0));
